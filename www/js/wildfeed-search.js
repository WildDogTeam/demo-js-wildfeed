function WildfeedSearch(ref, stem, resultsHandler) {
  this._ref = ref;
  this._term = stem;
...
WildfeedSearch.prototype = {
  ...
  _startSearchForStem: function(stem) {
    ...
    // TODO: check valid wilddog key here
...
WildfeedSearch.prototype.containsTerm = function(term) {
  if (term.length < 3) {
    return false;
  } else {
...
WildfeedSearch.prototype.updateTerm = function(term) {
  this._term = term;
  this._raiseFilteredResults();
};

WildfeedSearch.prototype.stopSearch = function() {
